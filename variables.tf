...
variable "rendezvousIP" {
  type = string
  description = "private IP of bootstrap instance for disconnected install"
}
...
variable "ssh_pub_key" {
  type = string
  description = "public key for ssh into ocp nodes"
}
...
variable "mirrors" {
  type = string
  description = "ocp install mirror config"
}
...
variable "oci_config_private_key" {
  type = string
  description = "private key for oci cli config"
}

variable "webserver_private_key" {
  type = string
  description = "private key for opc webserver ssh for ansible"
}
